...
import Connekt from "@/app/auth/register/_components/connekt";
  ...
  return (
    <section className="flex justify-center m-2 p-2 mt-24">
        <Tabs defaultValue="public" className="w-[800px] overflow-x-auto">
            <TabsList className="w-full bg-indigo-600 h-18 flex flex-wrap md:grid grid-cols-2">
                ...
                <TabsTrigger value="connekt">
                    <div className="flex">
                        ...
                        <span className="ml-2 text-base"> Connekt </span>
                    </div>
                </TabsTrigger>
            ...
            <TabsContent value="connekt"> <Connekt /> </TabsContent>
