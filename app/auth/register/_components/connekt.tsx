...
const Component = () => {
  ...
  return (
    <Card className="bg-zinc-700/75">
      <CardHeader>
        <CardTitle> Connekt </CardTitle>
        <CardDescription>
        Be the change to bring the change. Have a vibrant solution to a sensible problem? Here&apos;s the platform to pitch and shape your ideas.
        </CardDescription>
      </CardHeader>
